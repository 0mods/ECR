...
class StructPos private constructor(private val positions: List<BlockPos>) {
    companion object {
        @get:JvmStatic
        @get:JvmName("builder")
        val builder = Builder()
        ...
        @JvmStatic
        fun of(positions: List<BlockPos>) = StructPos(positions)
    }
