package com.algorithmlx.ecr.api.plugin.registry.helper

import com.algorithmlx.ecr.api.LOGGER
import com.algorithmlx.ecr.api.registries.Registrar
import com.algorithmlx.ecr.api.rl
...
open class RegistryImplementer<T>(val modId: String, val registry: Registrar<T>): ECRegistryObject<T> {
     ...
     *
     * @return a [Map] of [Identifier]s and their corresponding instances of [T].
     */
    override val registered: Map<Identifier, T>
