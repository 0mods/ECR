...
actual object BlockRegistry {
    ...
    actual val mithrilineFurnace: MithrilineFurnace by lazy { mithrilineFurnaceBlock.get() }
    actual val mithrilineCrystal: CrystalBlock by lazy { mithrilineCrystalBlock.get() }
    actual val magicTable: MagicTable by lazy { magicTableBlock.get() }
    actual val matrixDestructor: MatrixDestructor by lazy { matrixDestructorBlock.get() }
    actual val solarPrism: SolarPrism by lazy { solarPrismBlock.get() }
    actual val coldDistiller: ColdDistiller by lazy { coldDistillerBlock.get() }
    actual val voidStone: Block by lazy { voidStoneBlock.get() }
    actual val mithrilinePlating: Block by lazy { mithrilinePlatingBlock.get() }
    actual val pale: Block by lazy { paleBlock.get() }
    actual val palePlating: Block by lazy { palePlatingBlock.get() }
    actual val magicPlating: Block by lazy { magicPlatingBlock.get() }
    actual val demonicPlating: Block by lazy { demonicPlatingBlock.get() }
    actual val flameCluster: Block by lazy { flameClusterBlock.get() }
    actual val waterCluster: Block by lazy { waterClusterBlock.get() }
    actual val earthCluster: Block by lazy { earthClusterBlock.get() }
    actual val airCluster: Block by lazy { airClusterBlock.get() }
