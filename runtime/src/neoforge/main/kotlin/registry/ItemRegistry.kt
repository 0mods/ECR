...
actual object ItemRegistry {
    ...
    // implements
    actual val soulStone: SoulStone by lazy { soulStoneItem.get() }
    actual val researchBook: ResearchBookItem by lazy { researchBookItem.get() }
    actual val boundGem: BoundGemItem by lazy { boundGemItem.get() }

    actual val weaknessElementalAxe: WeakAxe by lazy { weakAxeItem.get() }
    actual val weaknessElementalHoe: WeakHoe by lazy { weakHoeItem.get() }
    actual val weaknessElementalPickaxe: WeakPickaxe by lazy { weakPickaxeItem.get() }
    actual val weaknessElementalShovel: WeakShovel by lazy { weakShovelItem.get() }
    actual val weaknessElementalSword: WeakSword by lazy { weakSwordItem.get() }

    actual val elementalGem: Item by lazy { elementalGemItem.get() }
    actual val flameGem: Item by lazy { flameGemItem.get() }
    actual val waterGem: Item by lazy { waterGemItem.get() }
    actual val earthGem: Item by lazy { earthGemItem.get() }
    actual val airGem: Item by lazy { airGemItem.get() }

    actual val elementalCore: Item by lazy { elementalCoreItem.get() }
    actual val combinedMagicAlloys: Item by lazy { combinedMagicAlloysItem.get() }
    actual val demonicCore: Item by lazy { demonicCoreItem.get() }
    actual val diamondPlate: Item by lazy { diamondPlateItem.get() }
    actual val emeraldPlate: Item by lazy { emeraldPlateItem.get() }
    actual val enderScaleAlloy: Item by lazy { enderScaleAlloyItem.get() }
    actual val forcefieldCore: Item by lazy { forcefieldCoreItem.get() }
    actual val forcefieldPlating: Item by lazy { forcefieldPlationgItem.get() }
    actual val fortifiedFrame: Item by lazy { fortifiedFrameItem.get() }
    actual val magicFortifiedPlating: Item by lazy { magicFortifiedPlatingItem.get() }
    actual val magicPlate: Item by lazy { magicPlateItem.get() }
    actual val magicPurifiedBlazeAlloy: Item by lazy { magicPurifiedBlazeAlloyItem.get() }
    actual val magicPurifiedEnderScaleAlloy: Item by lazy { magicPurifiedEnderScaleAlloyItem.get() }
    actual val magicPurifiedGlassAlloy: Item by lazy { magicPurifiedGlassAlloyItem.get() }
    actual val obsidianPlate: Item by lazy { obsidianPlateItem.get() }
    actual val paleCore: Item by lazy { paleCoreItem.get() }
    actual val palePlate: Item by lazy { palePlateItem.get() }
    actual val particleCatcher: Item by lazy { particleCatcherItem.get() }
    actual val particleEmitter: Item by lazy { particleEmitterItem.get() }
    actual val sunImbuedGlass: Item by lazy { sunImbuedGlassItem.get() }
    actual val voidPlating: Item by lazy { voidPlatingItem.get() }
    actual val mithrilineIngot: Item by lazy { mithrilineIngotItem.get() }
    actual val magicalIngot: Item by lazy { magicalIngotItem.get() }
    actual val mithrilineDust: Item by lazy { mithrilineDustItem.get() }
    actual val heatingRod: Item by lazy { heatingRodItem.get() }
    actual val mithrilineCrystalGem: Item by lazy { mithrilineCrystalGemItem.get() }
    actual val mruResonatingCrystal: Item by lazy { mruResonatingCrystalItem.get() }
    actual val fadingCrystal: Item by lazy { fadingCrystalItem.get() }
