...
object FabricRecipeDisplayTypeRegistry : RecipeDisplayTypeRegistry {
    override val mithrilineFurnace: RecipeDisplay.Type<MithrilineFurnaceRecipe.Display> =
        register(
