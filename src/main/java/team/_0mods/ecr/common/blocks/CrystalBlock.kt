...
class CrystalBlock(properties: Properties) : Block(properties) {
    ...
    fun makeShape(): VoxelShape {
        ...
        shape = Shapes.join(shape, Shapes.box(0.6875, 0.9375, 0.3125, 0.8125, 1.0, 0.6875), BooleanOp.OR)
        shape = Shapes.join(shape, Shapes.box(0.1875, 0.9375, 0.6875, 0.8125, 1.0, 0.8125), BooleanOp.OR)
        shape = Shapes.join(shape, Shapes.box(0.1875, 0.9375, 0.1875, 0.8125, 1.0, 0.3125), BooleanOp.OR)
        shape = Shapes.join(shape, Shapes.box(0.1875, 0.9375, 0.3125, 0.3125, 1.0, 0.6875), BooleanOp.OR)
        shape = Shapes.join(shape, Shapes.box(0.3125, 0.0, 0.3125, 0.6875, 0.0625, 0.6875), BooleanOp.OR)
        shape = Shapes.join(shape, Shapes.box(0.3125, 1.0, 0.3125, 0.6875, 1.0625, 0.6875), BooleanOp.OR)
        shape = Shapes.join(shape, Shapes.box(0.25, 0.1875, 0.25, 0.75, 0.875, 0.75), BooleanOp.OR)
