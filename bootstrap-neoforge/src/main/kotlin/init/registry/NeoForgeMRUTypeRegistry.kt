...
class NeoForgeMRUTypeRegistry(bus: IEventBus): MRUTypeRegistry {
    ...
    private val espeType = mruTypes.register("espe") { _ -> simple(Component.literal("ESPE")) }
    private val radiationUnitType = mruTypes.register("mru") { _ -> simple(Component.literal("MRU")) }
